$(document).ready(function () {
    ...
    *   Validation
    ...
    // validation of input radio

    $('.select-phone label').on('click', function() {
        $('.select-phone label').removeClass('active-input-radio');
        $(this).addClass('active-input-radio');
        ...
        message = $this.attr("data-message");
                ...
                success: function(data) {
                    ...
                    if (status === true) {
                        ...
                        var urlaction = url+'/manage_users/'+data.data.name;
                        $('.form-edit').attr('action',urlaction);
                        $('#name-edit').val(data.data.name);
                        $('#email-edit').val(data.data.email);
                        $('#gender-edit').val(data.data.gender);
                        $('#mobile-edit').val(data.data.mobile);
                        $('#address-edit').val(data.data.address);
                        $('.img-preview img').attr('src',img).show();
                        $('#file-edit').val(data.data.file);
