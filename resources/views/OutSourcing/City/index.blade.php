...
<section class="widget">
        <div class="container-fluid">
            <h1 class="widget-title mb-0">{{trans('city.create_city')}}</h1>
            <div class="widget-content mt-5">
                <form enctype="multipart/form-data" autocomplete="off"  method="POST" action="{{ route('city.store') }}"  class="user general-form form-create">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-sm-12 order-xl-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="name">{{trans('Forms.Governorate')}} </label>
                                            <select name="governorates_id" id="governorates_id" class="form-control"
                                                title="{{trans('Forms.PlaceholderGovernorate')}}">
                                                <option class="form-control" value="">{{trans('Forms.PlaceholderGovernorate')}}
                                                </option>
                                                @forelse ($Governorates as $Governorate)
                                                <option class="form-control" value="{{$Governorate->id}}">{{$Governorate->name}}</option>
                                                @empty
                        ...
                        <div class="col-xl-12 col-sm-12 order-xl-0">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name">{{trans('Forms.Governorate')}} </label>
                                        <select name="governorates_id" id="governorates_id-edit" class="form-control"
                                            title="{{trans('Forms.PlaceholderGovernorate')}}">
                                            <option class="form-control" value="">{{trans('Forms.PlaceholderGovernorate')}}
                                            </option>
                                            @forelse ($Governorates as $Governorate)
    ...
    <section id="tableSection" class="widget all-users">
        <div class="container-fluid">
            <h1 class="widget-title mb-0">{{trans('city.Allcity')}}</h1>
...
<script src="{{ asset('assist/scripts/modules/OutSourcing/city.js')}}"></script>
